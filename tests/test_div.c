...
Suite *suite_div(void) {
  ...
  //   tcase_add_test(tc, div_6_test);  // отлет по нормализации, оригинал
  //   работает
  tcase_add_test(tc, div_7_test);
  tcase_add_test(tc, div_9_test);
  tcase_add_test(tc, div_10_test);
  tcase_add_test(tc, div_11_test);
  //   tcase_add_test(tc, div_12_test);  // отлет по нормализации, оригинал
  //   работает
  tcase_add_test(tc, div_13_test);
  //   tcase_add_test(tc, div_14_test);  // отлет по нормализации, оригинал
  //   работает tcase_add_test(tc, div_15_test);  // отлет по нормализации,
  //   оригинал работает tcase_add_test(tc, div_16_test);  // отлет по
  //   нормализации, оригинал работает tcase_add_test(tc, div_17_test);  //
  //   отлет по нормализации, оригинал работает
