...
Suite *suite_is_greater_or_equal(void) {
  ...
  tcase_add_test(tc, is_gr_eq_1);
  tcase_add_test(tc, is_gr_eq_2);
  tcase_add_test(tc, is_gr_eq_3);
  tcase_add_test(tc, is_gr_eq_4);
  tcase_add_test(tc, is_gr_eq_5);
  tcase_add_test(tc, is_gr_eq_6);
